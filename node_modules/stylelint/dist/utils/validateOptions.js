...
exports.default = function (result, ruleName) {
  ...
  function validate(_ref) {
    ...
    if (_lodash2.default.isFunction(possible)) {
      if (!possible(actual)) {
    ...
    if (!_lodash2.default.isPlainObject(possible)) {
    ...
    if (!_lodash2.default.isPlainObject(actual)) {
    ...
    function complain(message) {
      ...
      _lodash2.default.set(result, "stylelint.stylelintError", true);
    }
  }
};
