...
exports.default = function (expectation, options) {
  return function (root, result) {
    ...
    root.walkAtRules(function (atRule) {
      ...
      if ((0, _utils.optionsHaveIgnoredAtRule)(options, atRule)) {
        return;
      }

      // Optionally ignore the expectation if the node is blockless
      if ((0, _utils.optionsHaveIgnored)(options, "blockless-group") && !(0, _utils.hasBlock)(atRule)) {
        return;
      }
      ...
      function getsBlocklessGroupException() {
        return (0, _utils.optionsHaveException)(options, "blockless-group") && previousNode && previousNode.type === "atrule" && !(0, _utils.hasBlock)(previousNode) && !(0, _utils.hasBlock)(atRule);
      }
