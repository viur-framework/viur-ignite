  ...
  return function (root, result) {
    ...
    function checkMultilineBit(source, newlineIndentLevel, node) {
      ...
      (0, _styleSearch2.default)({
        source: source,
        target: "\n",
        outsideParens: (0, _utils.optionsHaveIgnored)(options, "inside-parens")
      }, function (match, matchCount) {
        var precedesClosingParenthesis = /^[ \t]*\)/.test(source.slice(match.startIndex + 1));

        if ((0, _utils.optionsHaveIgnored)(options, "inside-parens") && (precedesClosingParenthesis || match.insideParens)) {
          return;
        }

        var expectedIndentLevel = newlineIndentLevel;
        // Modififications for parenthetical content
        if (!(0, _utils.optionsHaveIgnored)(options, "inside-parens") && match.insideParens) {
