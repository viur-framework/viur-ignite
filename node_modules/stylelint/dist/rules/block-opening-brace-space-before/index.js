...
exports.default = function (expectation, options) {
  ...
  return function (root, result) {
    ...
    function check(statement) {
      ...
      if ((0, _utils.optionsHaveIgnoredAtRule)(options, statement)) {
        return;
      }

      var source = (0, _utils.beforeBlockString)(statement);
      var beforeBraceNoRaw = (0, _utils.beforeBlockString)(statement, { noRawBefore: true });
