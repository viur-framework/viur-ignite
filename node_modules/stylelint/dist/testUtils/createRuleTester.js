...
exports.default = function (equalityCheck) {
  return function (rule, schema) {
    var alreadyHadOnlyTest = !!onlyTest;
    if (schema.accept) {
      schema.accept.forEach(_lodash2.default.partial(checkCaseForOnly, "accept"));
    }

    if (schema.reject) {
      schema.reject.forEach(_lodash2.default.partial(checkCaseForOnly, "reject"));
    }

    if (onlyTest) {
      schema = _lodash2.default.assign(_lodash2.default.omit(schema, ["accept", "reject"]), _defineProperty({
      ...
      var resultPromise = postcssProcess(rejectedCase.code).then(function (postcssResult) {
        ...
        if (rejectedCase.line) {
          comparisons.push({
            ...
            actual: _lodash2.default.get(warning, "line"),
        ...
        if (rejectedCase.column !== undefined) {
          comparisons.push({
            ...
            actual: _lodash2.default.get(warning, "column"),
        ...
        if (rejectedCase.message) {
          comparisons.push({
            ...
            actual: _lodash2.default.get(warning, "text"),
